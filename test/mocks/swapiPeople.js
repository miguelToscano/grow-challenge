const peopleSinglePageResponse = {
	"count": 1,
...
const peopleSecondPageResponse = {
	"count": 20,
	"next": "http://swapi.dev/api/people/?page=2",
	"previous": null,
	"results": [
...
module.exports = {
    peopleSinglePageResponse,
    peopleFullPageResponse,
    peopleFirstPageResponse,
    peopleSecondPageResponse
}