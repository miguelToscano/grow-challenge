const planetsSinglePageResponse = {
	"count": 1,
...
const planetsFirstPageResponse = {
	"count": 15,
	"next": "http://swapi.dev/api/planets/?page=2",
	"previous": null,
	"results": [
...
const planetsSecondPageResponse = {
	"count": 15,
	"next": "http://swapi.dev/api/planets/?page=2",
	"previous": null,
	"results": [
...
module.exports = {
    planetsSinglePageResponse,
    planetsFullPageResponse,
    planetsFirstPageResponse,
    planetsSecondPageResponse
}